...
class Crepe(nn.Module):
    ...
    def __init__(self, weight_file):
        ...
        self.conv1 = self.__conv(2, name='conv1', in_channels=1, out_channels=1024, kernel_size=(512, 1), stride=(4, 1), groups=1, bias=True)
        self.conv1_BN = self.__batch_normalization(2, 'conv1-BN', num_features=1024, eps=0.0010000000474974513, momentum=0.0)
        self.conv2 = self.__conv(2, name='conv2', in_channels=1024, out_channels=128, kernel_size=(64, 1), stride=(1, 1), groups=1, bias=True)
        self.conv2_BN = self.__batch_normalization(2, 'conv2-BN', num_features=128, eps=0.0010000000474974513, momentum=0.0)
        self.conv3 = self.__conv(2, name='conv3', in_channels=128, out_channels=128, kernel_size=(64, 1), stride=(1, 1), groups=1, bias=True)
        self.conv3_BN = self.__batch_normalization(2, 'conv3-BN', num_features=128, eps=0.0010000000474974513, momentum=0.0)
        self.conv4 = self.__conv(2, name='conv4', in_channels=128, out_channels=128, kernel_size=(64, 1), stride=(1, 1), groups=1, bias=True)
        self.conv4_BN = self.__batch_normalization(2, 'conv4-BN', num_features=128, eps=0.0010000000474974513, momentum=0.0)
        self.conv5 = self.__conv(2, name='conv5', in_channels=128, out_channels=256, kernel_size=(64, 1), stride=(1, 1), groups=1, bias=True)
        self.conv5_BN = self.__batch_normalization(2, 'conv5-BN', num_features=256, eps=0.0010000000474974513, momentum=0.0)
        self.conv6 = self.__conv(2, name='conv6', in_channels=256, out_channels=512, kernel_size=(64, 1), stride=(1, 1), groups=1, bias=True)
        self.conv6_BN = self.__batch_normalization(2, 'conv6-BN', num_features=512, eps=0.0010000000474974513, momentum=0.0)
        self.classifier = self.__dense(name = 'classifier', in_features = 2048, out_features = 360, bias = True)
    ...
    def forward(self, x):
        ...
        flatten         = conv6_dropout.reshape(-1, 2048)
